...
class TestAddNewNumber(unittest.TestCase):
    def setUp(self):
    ...
    def test_add_new_number(self):
        ...
        self.open_form(wd)
        self.create_contact(wd, Contact(firstname="Ksy", middlename="LOP", lastname="lop", nickname="p4oolo", title="title", company="cft", address="ivanova 8", homenumber="8903678909", mobile="8907543226",
